...
yaml_script_copy=./scripts/temp_58pctOn_2back_ricochet_rate_analyzer.yaml

# Replace all instances of init_descriptor with new_descriptor in
# the .yaml script
init_descriptor='ric_rate_example'
new_descriptor='ric_rate_58pctOn_2pctOff_2back'
...
rate_cns_params='[0.58,0.02,True,True,40,0.05]'
