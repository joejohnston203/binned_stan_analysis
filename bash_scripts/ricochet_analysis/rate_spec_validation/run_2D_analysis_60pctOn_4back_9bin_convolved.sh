...
yaml_script_copy=./scripts/temp_60pctOn_4back_ricochet_rate_spec_convolved_analyzer.yaml

# Replace all instances of init_descriptor with new_descriptor in
# the .yaml script
init_descriptor='ric_rate_spec_example'
new_descriptor='ric_rate_spec_convolved_60pctOn_4back'
...
# Use convolved exponential for energy dependence
