...
parameters{
  ...
  // vector[nBins_0][nBins_1] log_n_counts_recon_envelope; // gaussian envelope in each bin for n_counts_recon
  real<lower=background_lb,upper=background_ub> background_rate;
}
...
transformed parameters {
  ...
  // vector[nBins_0,nBins_1] n_counts_recon_envelope;
  real background_rate_1;
  real background_rate_2;
  real background_rate_3;
  real background_rate_4;
  ...
  // For plotting purposes, set background_rate_i
  background_rate_1=background_rate;
  background_rate_2=0.0;
  background_rate_3=0.0;
  background_rate_4=0.0;
}
